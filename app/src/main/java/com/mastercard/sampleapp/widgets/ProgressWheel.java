package com.mastercard.sampleapp.widgets;
...
public class ProgressWheel extends View {
    ...
    private final Handler spinHandler = new Handler(new Handler.Callback() {
        /**
    ...
    private void parseAttributes(TypedArray a) {
        barWidth = (int) a.getDimension(R.styleable.ProgressWheel_wheelBarWidth, barWidth);
    ...
    private void setupBounds() {
        ...
        circleInnerContour = new RectF(circleBounds.left + (rimWidth / 2.0f) + (contourSize / 2.0f),
                                       ...
                                       circleBounds.right - (rimWidth / 2.0f) - (contourSize
                                                                                 / 2.0f),
                                       circleBounds.bottom - (rimWidth / 2.0f) - (contourSize
                                                                                  / 2.0f));
