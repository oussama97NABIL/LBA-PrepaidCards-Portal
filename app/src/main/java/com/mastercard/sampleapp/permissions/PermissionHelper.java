...
package com.mastercard.sampleapp.permissions;
...
public class PermissionHelper {
     ...
     * will be requested
     *
     * @param permissions     Collections of String Permissions as defined in Android Manifest
     *                        class
    ...
    public static boolean requestPermissions(String[] permissions,
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            ...
            if (!permissionsNeedRequesting.isEmpty()) {
                ...
                callingActivity.requestPermissions(permissionsNeedRequesting.toArray(
                        new String[permissionsNeedRequesting.size()]), requestCode);
    ...
    /**
     * Checks to see if the requested permission is already granted. Does not request the
     * permission
     ...
     * been made
     */
    public static boolean requestPermissions(String permission, Activity callingActivity,
                                             int requestCode) {
