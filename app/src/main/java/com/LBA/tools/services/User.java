...
public class User {
    ...
    static public void getToken() throws Exception {

        JSONObject jsonObject = new JSONObject();

        jsonObject.put("userName", Globals.user);
        ...
        Globals.userName = jsonRespObject.getString("token");
        Globals.operation = jsonRespObject.getString("operation");
        Log.e("TAG", "login: Globals.authenToken" + Globals.authenToken);
