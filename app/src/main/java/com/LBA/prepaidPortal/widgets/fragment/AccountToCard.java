...
public class AccountToCard extends BaseFragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        mRootView = inflater.inflate(R.layout.account_to_card_fragment, container, false);
